...
%% Initial settings
% Light source
source_init_pos_x = 1.0; % Position of light source
source_init_pos_y = 1.0; % m
source_init_dir_x = cos(223*pi/180); % Direction of light source
source_init_dir_y = sin(223*pi/180); % m
% CCD
CCD_init_pos_x = -1.1; % Position of light source
CCD_init_pos_y = 1.0; % m
CCD_init_dir_x = cos(-30*pi/180); % Direction of light source
CCD_init_dir_y = sin(-30*pi/180); % m
% Calculate the beam
...
% Plot the CCD
CCD_init_block_x = [CCD_init_pos_x-CCD_init_dir_y*0.1,CCD_init_pos_x+CCD_init_dir_y*0.1];
CCD_init_block_y = [CCD_init_pos_y+CCD_init_dir_x*0.1,CCD_init_pos_y-CCD_init_dir_x*0.1];
plot(CCD_init_block_x,CCD_init_block_y,'k','LineWidth',5)
...
% Plot the CCD
CCD_mirror_rotated_block_x = [CCD_mirror_rotated_pos_x-CCD_mirror_rotated_dir_y*0.1,CCD_mirror_rotated_pos_x+CCD_mirror_rotated_dir_y*0.1];
CCD_mirror_rotated_block_y = [CCD_mirror_rotated_pos_y+CCD_mirror_rotated_dir_x*0.1,CCD_mirror_rotated_pos_y-CCD_mirror_rotated_dir_x*0.1];
...
disp('Tracking Error:')
disp(abs(CCD_spot_shift_mirror_rotated-CCD_spot_shift_init))
